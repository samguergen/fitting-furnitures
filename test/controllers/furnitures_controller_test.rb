...
class FurnituresControllerTest < ActionController::TestCase
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post :create, furniture: { description: @furniture.description, furnipoints: @furniture.furnipoints, image: @furniture.image, measurement: @furniture.measurement, name: @furniture.name }
    end
  ...
  test "should update furniture" do
    patch :update, id: @furniture, furniture: { description: @furniture.description, furnipoints: @furniture.furnipoints, image: @furniture.image, measurement: @furniture.measurement, name: @furniture.name }
    assert_redirected_to furniture_path(assigns(:furniture))
  end
